  ...
  return (
    <main className="safe mx-auto min-h-screen w-full max-w-2xl px-4 text-soia-green">
      <section className="mt-6 overflow-hidden rounded-[2.4rem] border border-soia-green/8 bg-[var(--tg-card)] shadow-card">
        <div className="bg-soia-green p-7 text-white"><div className="grid h-16 w-16 place-items-center rounded-3xl bg-white/12 text-soia-lime"><CartIcon /></div><p className="mt-6 text-xs font-black uppercase tracking-[0.16em] text-white/55">Mode: {order.mode}</p><h1 className="mt-2 text-4xl font-black tracking-[-0.06em]">Pesanan Berhasil Dibuat</h1><p className="mt-3 text-sm leading-6 text-white/70">Pesanan dibuat melalui REST API. Jika Supabase belum dikonfigurasi, aplikasi otomatis berjalan dalam Demo Mode.</p></div>
